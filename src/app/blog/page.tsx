...
function Blog() {
  ...
  <div className="mt-8 w-full lg:w-3/4 gap-6">
    {/* Single Blog Post */}
    {[
      { image: "/image/blog2.png", title: "Going all-in with millennial design", category: "Crafts", date: "01 Jan 2023" },
      { image: "/image/r2.png", title: "Exploring new ways of decorating", category: "Design", date: "15 Mar 2023" },
      { image: "/image/r3.png", title: "Handmade pieces that took time to make", category: "Wood", date: "20 Sep 2023" },
    ].map((post, index) => (
  ...
  <div className="mt-10 w-full lg:w-1/4 p-6 gap-6">
    ...
    <div className="p-6 rounded-lg">
      ...
      <div className="space-y-6">
        {[
          { image: '/image/r2.png', title: 'Going all-in with millennial design', date: '03 Aug 2022' },
          { image: '/image/r3.png', title: 'Exploring new ways of decorating', date: '03 Aug 2022' },
          { image: '/image/r2.png', title: 'Handmade pieces that took time to make', date: '03 Aug 2022' },
          { image: '/image/r3.png', title: 'Modern home in Milan', date: '03 Aug 2022' },
          { image: '/image/r2.png', title: 'Colorful office redesign', date: '03 Aug 2022' },
        ].map((post, index) => (
